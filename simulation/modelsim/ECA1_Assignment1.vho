...
-- outputDataReady	=>  Location: PIN_AF26,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL ww_outputDataReady : std_logic;
...
ww_clk <= clk;
outputDataReady <= ww_outputDataReady;
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;

-- Location: IOOBUF_X86_Y0_N53
\outputDataReady~output\ : cyclonev_io_obuf
